                        ...
                        children: <Widget>[
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.only(left: 32.0, right: 32.0, bottom: 16.0, top: 16.0),
                                alignment: Alignment.topCenter,
                                child: TextDandyLight(
                                  type: TextDandyLight.SMALL_TEXT,
                                  text: 'Deleting your DandyLight account will remove all data stored on your device and in our database.   '
