...
class SettingsPageState {
  ...
  factory SettingsPageState.initial() => SettingsPageState("", new List(), new List(), null, null, null, null,);

  factory SettingsPageState.create(Store<AppState> store) {
