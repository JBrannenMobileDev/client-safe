      ...
      builder: (BuildContext context, NewContactPageState pageState) =>
          TextButton(
            style: Styles.getButtonStyle(
              ...
              color: pageState.filteredDeviceContacts!.elementAt(index).identifier == pageState.selectedDeviceContact?.identifier ? Color(ColorConstants.getPrimaryGreyDark()) : Colors.transparent,
            ),
            onPressed: () {
