...
class _MarriedSpouseState extends State<MarriedSpouse> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
      ...
      StoreConnector<AppState, NewContactPageState>(
        ...
        builder: (BuildContext context, NewContactPageState pageState) =>
          ...
          child: Stack(
            children: <Widget>[
              Container(
                margin: EdgeInsets.only(bottom: getRelationshipIndex(pageState.relationshipStatus) != 2 ? 172.0 : 0.0),
                  alignment: Alignment.center,
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "Does " + pageState.newContactFirstName + " have a significant other?",
                      ...
                      Container(
                        ...
                        child: CupertinoSegmentedControl<int>(
                          ...
                          groupValue: getRelationshipIndex(pageState.relationshipStatus),
                        ),
                      ),
                    ],
                  ),
              ...
              AnimatedOpacity(
                opacity: getRelationshipIndex(pageState.relationshipStatus) == 2 ? 0.0 : 1.0,
