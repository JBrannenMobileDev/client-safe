...
class _NameAndGenderState extends State<NameAndGender> with AutomaticKeepAliveClientMixin{
        ...
        builder: (BuildContext context, NewContactPageState pageState) =>
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              NewContactTextField(firstNameTextController, "First Name",
                  TextInputType.text, 60.0, pageState.onClientFirstNameChanged, NewContactPageState.ERROR_FIRST_NAME_MISSING),
              NewContactTextField(lastNameTextController, "Last Name",
                  TextInputType.text, 60.0, pageState.onClientLastNameChanged, NewContactPageState.NO_ERROR),
            ],
          ),
        ),
      );
