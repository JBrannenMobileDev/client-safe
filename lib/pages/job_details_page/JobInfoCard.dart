                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: TextDandyLight(
                                type: TextDandyLight.MEDIUM_TEXT,
                                text: (pageState.job.selectedTime != null ? DateFormat('h:mm a').format(pageState.job.selectedTime) : 'Start time not selected'),
                                textAlign: TextAlign.start,
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: TextDandyLight(
                                ...
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                                color: Color(pageState.job.location != null ? ColorConstants.getPrimaryBlack() : ColorConstants.error_red),
                              ),
                            ),
                          ],
                        ),
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: TextDandyLight(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 1,
                                  color: Color(pageState.job.priceProfile != null ? ColorConstants.getPrimaryBlack() : ColorConstants.error_red),
                                ),
                              ),
                            ],
                       ),
