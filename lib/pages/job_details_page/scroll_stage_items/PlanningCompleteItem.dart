...
class PlanningCompleteItem extends StatefulWidget {
  final double scrollPosition;

  PlanningCompleteItem({this.scrollPosition});

  @override
  State<StatefulWidget> createState() {
    return _PlanningCompleteItemState();
  }
}

class _PlanningCompleteItemState extends State<PlanningCompleteItem> with TickerProviderStateMixin {
...
//                  ),
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: ImageUtil.getJobStageImage(5),
                        fit: BoxFit.contain,
                      ),
                    ),
                  ),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.only(left: 48.0, top: 208.0),
                        child: Text(
                          'Planning complete?',
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Finalize all of the details for this job.',
                          textAlign: TextAlign.start,
                          style: TextStyle(
                            fontSize: 14.0,
                            fontFamily: 'Raleway',
