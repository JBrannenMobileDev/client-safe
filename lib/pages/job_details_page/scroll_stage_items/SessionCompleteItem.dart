...
class SessionCompleteItem extends StatefulWidget {
  final double scrollPosition;

  SessionCompleteItem({this.scrollPosition});

  @override
  State<StatefulWidget> createState() {
    return _SessionCompleteItemState();
  }
}

class _SessionCompleteItemState extends State<SessionCompleteItem> with TickerProviderStateMixin {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: ImageUtil.getJobStageImage(6),
                        fit: BoxFit.contain,
                      ),
                    ),
                  ),
