...
class PaymentReceivedItem extends StatefulWidget {
  final double scrollPosition;

  PaymentReceivedItem({this.scrollPosition});

  @override
  State<StatefulWidget> createState() {
    return _PaymentReceivedItemState();
  }
}

class _PaymentReceivedItemState extends State<PaymentReceivedItem>
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: ImageUtil.getJobStageImage(8),
                        fit: BoxFit.contain,
                      ),
                    ),
                  ),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Receive full payment to complete this stage.',
                          textAlign: TextAlign.start,
                          style: TextStyle(
                            fontSize: 14.0,
                            fontFamily: 'Raleway',
