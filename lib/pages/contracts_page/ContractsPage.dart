                      ...
                      delegate: new SliverChildListDelegate(
                        <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text(
                              "You have not uploaded any contracts yet. To save a contract, select the plus icon.",
    ...
    return StoreConnector<AppState, ContractsPageState>(
      ...
      builder: (BuildContext context, ContractsPageState pageState) =>
          Container(
            ...
            child: ContractListWidget(pageState.contracts.elementAt(index), pageState, onContractSelected, Colors.white, Color(ColorConstants.getPrimaryBlack())),
          ),
    );
  }

  onContractSelected(Contract contract, ContractsPageState pageState,  BuildContext context) {
    pageState.onContractSelected(contract);
