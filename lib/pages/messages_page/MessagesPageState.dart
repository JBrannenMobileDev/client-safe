...
class MessagesPageState {
  ...
  factory MessagesPageState.initial() => MessagesPageState("", new List(), new List(), null, null, null, null,);

  factory MessagesPageState.create(Store<AppState> store) {
    return new MessagesPageState(
