...
class ContractUtils {
  ...
  static quill.Document replaceDataItems(quill.Document document, Profile profile, Job job) {
    ...
    replaceAll(document, Job.DETAIL_RETAINER_PRICE, job.invoice != null && job.invoice.depositAmount != null ? TextFormatterUtil.formatDecimalCurrency(job.invoice.depositAmount) : job.invoice == null && job.priceProfile.deposit != null ? TextFormatterUtil.formatDecimalCurrency(job.priceProfile.deposit) : 'TBD');
    ...
    replaceAll(document, Job.DETAIL_REMAINING_BALANCE,  job.invoice != null ? TextFormatterUtil.formatDecimalCurrency(job.invoice.total - job.invoice.depositAmount) : job.invoice == null ? TextFormatterUtil.formatDecimalCurrency(job.priceProfile.flatRate - job.priceProfile.deposit) : 'N/A');
    return document;
  }
