...
class JobUtil {
  static List<Job> getJobsInProgress(List<Job> jobs) {
    ...
    _jobsInProgress.sort((job1, job2) => job1.getMillisecondsUntilJob().compareTo(job2.getMillisecondsUntilJob()));
  ...
  static List<Job> getJobsCompleted(List<Job> jobs) {
    ...
    _jobsCompleted.sort((job1, job2) => job1.getMillisecondsUntilJob().compareTo(job2.getMillisecondsUntilJob()));
