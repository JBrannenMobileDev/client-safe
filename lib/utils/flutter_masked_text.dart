...
class MaskedTextController extends TextEditingController {
  MaskedTextController({required String text, required this.mask, required this.translator}) : super(text: text) {
...
class MoneyMaskedTextController extends TextEditingController {
  ...
  _validateConfig() {
    bool rightSymbolHasNumbers = _getOnlyNumbers(rightSymbol).length > 0;
